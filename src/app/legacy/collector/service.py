...
from app.core.classifier.jump_classifier import is_valid_price
from app.gateway.native.ctp_binding import CtpMdClient
from app.legacy.collector.live import LiveClassifier, LiveState, live_feed_path
...
class CollectorService:
    ...
    def on_depth_market_data(self, fields: dict) -> None:
        ...
        from app.gateway.native.ctp_binding import depth_fields_to_row
